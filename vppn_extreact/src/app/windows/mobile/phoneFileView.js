...
import PhoneFileSidebar from '../../components/phone/fileSidebar';
...
var timer = null;
var PhoneFileView = React.createClass({
  ...
  componentDidMount: function() {
    var phoneFileWindow = this.props.manager.get('phone_file');
    setWinHeight(this.props.id, phoneFileWindow.width, phoneFileWindow.height);
    // document.addEventListener('mousemove', this.handleMouseMove);

    timer = setInterval(function(){
      if(this.props.windowSizeChange.flag && this.props.windowSizeChange.windowId=='phone_file') {
        var phoneFileWindow = this.props.manager.get('phone_file');
        setWinHeight(this.props.id, phoneFileWindow.width, phoneFileWindow.height);
      }
    }.bind(this), 10);
  ...
  render: function() {
    ...
    return (
      <div className="grid condensed no-margin net-win" id="phoneFileWindow" style={{margin:"0 1px"}}>
