...
import AppWithSearchBarFilter from 'routing/filter/AppWithSearchBar';
...
import BusinessFlowViewPage from 'pages/BusinessFlowViewPage';
import BusinessFlowViewDetailPage from 'pages/BusinessFlowViewDetailPage';
import BusinessWebErrorDetailPage from 'pages/BusinessWebErrorDetailPage';
import BusinessViewPage from 'pages/BusinessViewPage';
import AlarmInfoPage from 'pages/AlarmInfoPage';
import RealTimeStreamsPage from 'pages/RealTimeStreamsPage';

import Bjca from 'pages/BjcaPage';

var { Provider } = require('react-redux');
var configureStore = require('itoss/store/configureStore');
  ...
  render() {
    ...
    return (
      ...
      <Router history={history}>
        ...
        <Route component={AppWithSearchBarFilter}>
            <Route path={Routes.FILTERSEARCH} component={FilterSearchPage}/>
        </Route>
          <Route component={AppWithoutSearchBar}>
            ...
            <Route path={Routes.REALTIMESTREAMS} component={RealTimeStreamsPage}/>
            ...
            <Route path={Routes.ARCHITECTUREDIAGRAM} component={ArchitectureDiagramPage}/>
            <Route path={Routes.BUSINESSFLOWVIEW} component={BusinessFlowViewPage}/>
            <Route path={Routes.BUSINESSFLOWDETAILVIEW} component={BusinessFlowViewDetailPage}/>
            <Route path={Routes.BUSINESSWEBERRORDETAILVIEW} component={BusinessWebErrorDetailPage}/>
            <Route path={Routes.BUSINESSVIEW} component={BusinessViewPage}/>
            <Route path={Routes.BJCA} component={Bjca}/>
            <Route path={Routes.ALARMINFO} component={AlarmInfoPage}/>
