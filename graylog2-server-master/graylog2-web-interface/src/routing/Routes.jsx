const Routes = {
  ...
  BUSINESSFLOWVIEW: '/businessflowview',
  BUSINESSFLOWDETAILVIEW: '/businessflowdetailview',
  BUSINESSWEBERRORDETAILVIEW: '/businessweberrordetailview',
  ...
  new_extractor: (nodeId, inputId) => {
    return `/systemSearch/inputs/${nodeId}/${inputId}/extractors/new`;
  },
