    ...
    initializeFieldsFromHash() {
        ...
        if (fieldsFromHash === undefined) {
            ...
            if (fieldsFromQuery === undefined) {
                ...
                var selectFildsArray = ['message', 'source'];
                var localSelectField =   localStorage.getItem('onSelectField');
                if(localSelectField != undefined){
                  selectFildsArray = localSelectField.split(',');
                }
                this.fields = Immutable.Set<string>(selectFildsArray);
                //this.fields = Immutable.Set<string>(['EquipmentId','EquipmentIP','GroupName','LogTime','message','MonitorEntry','MonitorId','MonitorIntValue','MonitorName','MonitorStatus','MonitorStringValue','MonitorType', 'source']);
            } else {
