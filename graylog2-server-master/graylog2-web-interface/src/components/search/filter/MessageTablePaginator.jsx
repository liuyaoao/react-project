...
const MessageTablePaginator = React.createClass({
  ...
  render() {
    ...
    pages.push(<Page key="previous" href="#" page="上一页" isDisabled={this.props.currentPage === 1}
    ...
    pages.push(<Page key="next" href="#" page="下一页" isDisabled={this.props.currentPage >= this._maxPage()}
                     onPageChanged={this._onPageChanged}/>);
