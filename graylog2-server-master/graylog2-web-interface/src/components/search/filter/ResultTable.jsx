...
import { MessageTableEntry, MessageTablePaginator } from 'components/search/filter';
  ...
  render() {
    ...
    return (
      <div className="content-col">
        <h1 className="pull-left">信息</h1>

        <ButtonGroup bsSize="small" className="pull-right">
          <Button title="展开所有信息" onClick={this.expandAll}><i className="fa fa-expand"/></Button>
          <Button title="折叠所有信息"
