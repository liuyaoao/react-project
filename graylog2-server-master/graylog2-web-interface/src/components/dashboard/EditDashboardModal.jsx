  ...
  render() {
    return (
      <BootstrapModalForm ref="modal"
                          title={this._isCreateModal() ? '新建仪表板' : '编辑仪表板 ' + this.props.title}
        ...
        <fieldset>
          ...
          <Input type="text" label="描述:" onChange={this._onDescriptionChange} value={this.state.description} required/>
        </fieldset>
      </BootstrapModalForm>
    );
  },
