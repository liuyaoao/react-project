        ...
        <Row id="global-inputs" className="content input-list">
          <Col md={12}>
            <h2>
              全局输入值
              &nbsp;
              <small>{this._nodeAffix()}有 {this.state.globalInputs.length} 个被配置</small>
            </h2>
            <EntityList bsNoItemsStyle="info" noItemsText="没有全局输入值。"
        ...
        <Row id="local-inputs" className="content input-list">
          <Col md={12}>
            <h2>
              本地输入值
              &nbsp;
              <small>{this._nodeAffix()}有 {this.state.localInputs.length} 个被配置</small>
            </h2>
            <EntityList bsNoItemsStyle="info" noItemsText={`${this._nodeAffix()}没有本地输入值。`}
