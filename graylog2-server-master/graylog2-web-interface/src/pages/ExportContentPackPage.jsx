            ...
            <form className="form-horizontal build-content-pack" onSubmit={this.onSubmit}>
              ...
              <div className="form-group">
                ...
                <Col sm={10}>
                  ...
                  <span className="help-block help-standalone">没有仪表板导出.</span>
                    :
                  <span>
              ...
              <div className="form-group">
                <Col smOffset={2} sm={10}>
                  ...
                  <p>
                    ...
                    Share your content pack with the community on the <a href="https://marketplace.deeplog.com/" target="_blank">DeepLOG Marketplace</a> after you have downloaded it.
                  </p>
                </Col>
              </div>
            </form>
