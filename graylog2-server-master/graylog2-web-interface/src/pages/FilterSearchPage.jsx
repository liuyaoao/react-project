...
import { MalformedSearchQuery, SearchResult } from 'components/search/filter';

const FilterSearchPage = React.createClass({
  propTypes: {
  ...
  render() {
    ...
    if(searchResult.all_fields.length > 0){
      var tempAllString = JSON.stringify(searchResult.all_fields);
      localStorage.setItem("searchAllName", tempAllString);
    }
    return (
