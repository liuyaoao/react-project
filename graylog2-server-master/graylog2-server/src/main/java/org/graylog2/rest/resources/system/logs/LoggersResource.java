...
public class LoggersResource extends RestResource {
    ...
    private static final Map<String, Subsystem> SUBSYSTEMS = ImmutableMap.<String, Subsystem>of(
            "graylog", new Subsystem("Deeplog", "org.graylog2", "来自Deeplog拥有系统的所有消息。"),
            "indexer", new Subsystem("Indexer", "org.elasticsearch", "与索引和搜索相关的所有消息。"),
            "authentication", new Subsystem("Authentication", "org.apache.shiro", "所有用户身份验证消息。"),
            "sockets", new Subsystem("Sockets", "netty", "与套接字通信相关的所有消息。"));
